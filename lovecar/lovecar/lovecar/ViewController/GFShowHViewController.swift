...
class GFShowHViewController: GFBaseViewController,UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let showLayout = GFShowHFlowLayout()

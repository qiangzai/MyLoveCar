...
class GFShowHFlowLayout: UICollectionViewFlowLayout {
...
//        print(kScreenWidth)
//        
//        let floatScale = proposedContentOffset.x/(itemSize.width + 80)
//        
//        proposedContentOffset.x = CGFloat(roundfloat(floatScale)) * CGFloat(itemSize.width - 100)
